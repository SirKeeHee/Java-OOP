...
public class Main {
    public static void main(String[] args) {
        Player player1 = new Player("Anto");
        Armor armor1 = new Armor("Baju Baja",10,100);
        Weapon weapon1 = new Weapon("Keris",10);
        player1.setArmor(armor1);
        player1.setWeapon(weapon1);

        Player player2 = new Player("Ujang");
        Armor armor2 = new Armor("Jas Hujan",5,50);
        Weapon weapon2 = new Weapon("Cangkul",15);
