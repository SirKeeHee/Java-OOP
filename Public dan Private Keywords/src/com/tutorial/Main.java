...
class Player{
    ...
    private int health; //private, dia hanya akan bisa dibaca dan ditulis di dalam class saja
    ...
    void display(){
        ...
        System.out.println("health\t: " + this.health); //membaca, tetapi hanya dalam class
    }
...
public class Main {
    public static void main(String[] args) {
        Player player1 = new Player("Sri",0,100);
...
//        System.out.println(player1.exp); //membaca data
        ...
        //public
        player1.ubahName("Anto");
        player1.display();

        //private (tidak bisa diakses karena diluar classs)
//        player1.tambahExp();
